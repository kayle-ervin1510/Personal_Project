...
SECRET_KEY = 'django-insecure-*9sf65x%1xzc%^4(=&(uy9wt&+5j&$91_mmb99(yc*48-3o%q0'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'personal_proj-container',#os.environ.get('DB_HOST','personal_proj-container'),
...
#Note to self - this was not the issue
